			...
			<div class="modal-content">
				...
				<div class="modal-body"> 
					<sf:form id="categoryForm" modelAttribute="category" action="${contextRoot}/manage/category" method="POST"
					 ...
					 <div class="form-group">
					 	<laber for="category_name" class="control-label col-md-4">Category Name</laber>
					 	<div class="col-md-8">
					 ...
					 <div class="form-group">
					 	<laber for="category_description" class="control-label col-md-4">Category Description</laber>
					 	<div class="col-md-8">
					 		<sf:textarea path="description" rows="5" id="category_description" class="form-control"></sf:textarea>
					 	</div>
					 </div>
