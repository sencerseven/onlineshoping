					...
					<div class="panel-body">
						<sf:form method="POST" class="form-horizontal" id="registerForm" modelAttribute="user">
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<sf:input path="email" type="text" class="form-control" placeholder="asd@asd.com"/>
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<sf:input path="contactNumber" type="text" class="form-control" placeholder="Contact Number"/>
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<sf:input path="confirmPassword" type="text" class="form-control" placeholder="Re-Enter Password"/>
							...
							<div class="form-group">
								<div class="col-md-offset-4 col-md-8">
									<button type="submit" class="btn btn-primary" name="_eventId_billing">Next Billing <i class="fas fa-arrow-right"></i></button>
								</div>
							</div>
